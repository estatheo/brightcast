...
export class ContactFormComponent {
    ...
    event;
    form;
    constructor(private router: Router, private formBuilder: FormBuilder, public windowRef: NbWindowRef, private toastrService: NbToastrService, private contactService: ContactService) {
    ...
    onSubmit() {
        this.contactService.NewContact({
          ...
          contactListId: parseInt(this.contactListId)
        }).subscribe(() => {
